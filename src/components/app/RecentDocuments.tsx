            ...
            {recentDocs.map((doc) => (
              <button
                ...
                className={cn(
                  ...
                  "hover:bg-gray-50 dark:hover:bg-gray-800 hover:border-[#1A2A4F] dark:hover:border-blue-500",
                  "transition-colors shrink-0",
                  "shadow-sm"
                )}
              >
                <FileText className="h-4 w-4 text-[#1A2A4F] dark:text-blue-400 shrink-0" />
