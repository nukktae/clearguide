...
export function AIAssistantWidget({ onStartChat }: AIAssistantWidgetProps) {
  ...
  return (
    <div className="bg-white dark:bg-[#1E293B] rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm">
      {/* Darker Header */}
      <div className="bg-[#1C2329] dark:bg-blue-900/80 px-5 py-3.5">
        <div className="flex items-center gap-3">
          ...
          <div className="relative shrink-0">
            ...
            <div className="absolute -top-1 -right-1 w-3 h-3 bg-green-500 rounded-full border-2 border-[#1C2329] dark:border-blue-900/80"></div>
          </div>
      ...
      <div className="p-5">
        ...
        <button
          ...
          className={cn(
            ...
            "bg-gradient-to-r from-[#1C2329] to-[#2A3441] dark:from-blue-600 dark:to-blue-700",
            "text-white text-sm font-semibold",
            "hover:from-[#2A3441] hover:to-[#3A4A6F] dark:hover:from-blue-700 dark:hover:to-blue-800",
