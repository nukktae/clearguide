  ...
  return (
    <div className={cn("w-full", className)}>
                ...
                <div
                  className={cn(
                    ...
                    isCompleted
                      ...
                      : isActive
                      ? "border-[#1C2329] dark:border-blue-400 bg-white dark:bg-gray-800"
      ...
      <div className="w-full h-1 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
        <div
          className="h-full bg-gradient-to-r from-[#1C2329] to-[#2DB7A3] dark:from-blue-500 dark:to-teal-400 transition-all duration-500 ease-out"
          style={{
